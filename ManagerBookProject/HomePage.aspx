<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true" CodeBehind="HomePage.aspx.cs" Inherits="ManagerBookProject.WebForm1" %>
    ...
    <section>
      <div class="container">
         <div class="row">
            ...
            <div class="col-md-4">
             ...
             <div class="col-md-4">
               <center>
                  <img width="150px" src="Image/search-online.png"/>
                  <h4>Search Books</h4>
                  <p class="text-justify">
            ...
            <div class="col-md-4">
               <center>
                  <img width="150px" src="Image/defaulters-list.png"/>
      ...
      <div class="container">
         ...
         <div class="row">
            <div class="col-md-4">
               <center>
                  <img width="150px" src="Image/sign-up.png" />
                  <h4>Sign Up</h4>
            ...
            <div class="col-md-4">
               <center>
                  <img width="150px" src="Image/library.png"/>
                  <h4>Visit Us</h4>
                  <p class="text-justify">Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Lorem ipsum dolor. reprehenderit</p>
               </center>
            </div>
